...
model1 = MarianOT.from_pretrained('model')
model1.eval()
res1 = model1.forward_pass(**batch)
tgt_logits1 = res1.tgt.logits.reshape(-1, 59514)
tsl_logits1 = res1.tsl.logits.reshape(-1, 59514)
tgt_loss1 = loss(tgt_logits1, tgt_labels)
tsl_loss1 = loss(tsl_logits1, tsl_labels)
print(tgt_loss1)
print(tsl_loss1)
